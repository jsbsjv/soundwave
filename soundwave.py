...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr}soundwave - TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@S_U_N_D0 BY HUNXBYTS      {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr}soundwave - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@S_U_N_D0 BY HUNXBYTS       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|  {Gr}soundwave - SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@S_U_N_D0 BY HUNXBYTS       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|    {Gr}soundwave - TRACKER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@S_U_N_D0 BY HUNXBYTS       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
